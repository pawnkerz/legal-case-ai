...
create type public.case_domain as enum ('immigration','family','housing','criminal','traffic','employment','consumer','civil','injury','probate','business','real_estate','bankruptcy','benefits','other');
...
create table public.entitlements (
  ...
  free_interactions_used integer not null default 0 check (free_interactions_used between 0 and 5),
...
create table public.cases (
  ...
  domain public.case_domain not null,
